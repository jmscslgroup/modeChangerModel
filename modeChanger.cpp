...
void modeChanger_step(void)
{
  ...
  b_varargout_1 = Sub_modeChanger_49.getLatestMessage
    (&modeChanger_B.BusAssignment);

  /* Outputs for Enabled SubSystem: '<S3>/Enabled Subsystem' incorporates:
   *  EnablePort: '<S5>/Enable'
   */
  if (b_varargout_1) {
    modeChanger_B.In1 = modeChanger_B.BusAssignment;
  }
   ...
   */
  switch (static_cast<int32_T>(modeChanger_B.publishPops)) {
   case 0:
    rtb_transition = modeChanger_P.NoChange_Value;
    break;

   case 2:
    rtb_transition = modeChanger_P.Next_Value;
    break;

   default:
    rtb_transition = modeChanger_P.Previous_Value;
    break;
  }
   ...
   */
  modeChanger_B.BusAssignment = modeChanger_P.Constant_Value_b;
  modeChanger_B.BusAssignment.Linear.X = rtb_transition;
